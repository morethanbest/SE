...
public class test {
    ...
    public void testNewBook(){
		...
		List<CommodityGetRegionVO> commodity = new ArrayList<CommodityGetRegionVO>();
		...
		CommodityGetRegionVO commodityInVO=new CommodityGetRegionVO("1", 20151115, new CommodityLocation(0, 0, 0, 0));
