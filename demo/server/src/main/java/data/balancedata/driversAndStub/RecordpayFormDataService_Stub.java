...
//		RecordpayPO po=new RecordpayPO(012664, 20131230, 21000, "����", "6461335", 3346, 200, 4000, 1000, "nothing");
//		list.add(po);
//		return list;
//	}
//
...
//		// TODO Auto-generated method stub
//		List<RecordpayPO> list=new ArrayList<RecordpayPO>();
//		RecordpayPO po=new RecordpayPO(012664, 20131230, 21000.0, "����", "6461335", 3346, 200, 4000, 1000, "nothing");
//		list.add(po);
//		return list;
//	}
//
