...
//		recordcollectFormDataService.addRecordcollectForm(new RecordcollectPO(12244, 20140412, 140000.0, "����", allordercode));
//		recordcollectFormDataService.updateRecordcollectForm(new RecordcollectPO(12244, 20140412, 140000.0, "����", allordercode));
